...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1307061498ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dblogistik&table=tbarang">`dblogistik`.`tbarang`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbpenjualan&table=tcustomer">`dbpenjualan`.`tcustomer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbpenjualan&table=tdistributor">`dbpenjualan`.`tdistributor`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dblogistik&table=tuser">`dblogistik`.`tuser`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbpenjualan&table=tuser">`dbpenjualan`.`tuser`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dblogistik&table=tjenis">`dblogistik`.`tjenis`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbpenjualan&table=tjenis">`dbpenjualan`.`tjenis`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbpenjualan&table=vbarang">`dbpenjualan`.`vbarang`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dblogistik&table=tb_user">`dblogistik`.`tb_user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbsekolah&table=tb_user">`dbsekolah`.`tb_user`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="47577e2a516e4a544570374b2a5a5c32">
